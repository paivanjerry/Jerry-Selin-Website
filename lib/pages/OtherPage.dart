                              ...
                              children: [
                                ...
                                Container(
                                    ...
                                    child: LocalVideoLoopPlayer(
                                        asset: "assets/videos/clipper.mp4"))
                              ],
                            ),
                          ),
                        ),
                          ...
                          children: [
                            ...
                            RichText(
                              text: TextSpan(
                                ...
                                children: <TextSpan>[
                                  TextSpan(text: tr("electronics_desc_2")),
                                  TextSpan(
                                      text: tr("electronics_desc_3"),
                                      style: TextStyle(
                                          fontWeight: FontWeight.bold)),
                                  TextSpan(text: tr("electronics_desc_4")),
                                ],
                              ),
                            ),
                            Container(
                            ...
                            Wrap(
                              ...
                              children: [
                                ...
                                Image.asset("assets/images/sauna.jpg", width: w > 700 ? 250 : w,)
                              ],
                            ),
                            Container(
                              height: 5,
                            ...
                            RichText(
                              text: TextSpan(
                                ...
                                children: <TextSpan>[
                                  ...
                                  TextSpan(text: tr("electronics_desc_6")),
                                ],
                              ),
                            ),
                          ],
                        ...
                        child: (Wrap(
                          children: [
                            Container(
                                width: w * 0.45,
                                child: LocalVideoLoopPlayer(
                                  asset: "assets/videos/whichspot.mp4",
                                )),
                            Container(
                                width: w * 0.45,
                                child: LocalVideoLoopPlayer(
                                  asset: "assets/videos/whichtrick.mp4",
                                )),
                          ],
                        )),
                      ),
